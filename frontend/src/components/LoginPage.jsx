    ...
    <div className="min-h-screen bg-paper flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm -mt-20">
          <h1
            className="font-display font-black text-ink headline-tight leading-none mb-2"
            style={{ fontSize: '2.5rem' }}
          >
            Olds
          </h1>
          <p className="text-muted text-sm mb-10 leading-relaxed">
            News connections across topics, personalized to how you read.
          </p>

          {emailSent ? (
            <div>
              <p className="font-display font-normal text-ink text-xl headline-tight mb-2">Check your inbox</p>
